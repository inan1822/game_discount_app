...
import { sendVerificationEmail, sendResetPasswordEmail } from "../../shared/utils/mailer.js";
...
export const loginService = async ({ email, password }) => {
    ...
    const token = jwt.sign({ id: user._id, name: user.name, role: user.role }, process.env.JWT_SECRET, { expiresIn: "2h" });
