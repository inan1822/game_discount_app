...
export const createProduct = async (req, res) => {
    try {
        const { Title: title, Price: price, description: description, category: category, stock: stock } = req.body;
...
export const getAllProducts = async (req, res) => {
    try {
        const { page = 1, limit = 10, category, minPrice, maxPrice, sort = "createdAt", order = "desc", search } = req.query;
